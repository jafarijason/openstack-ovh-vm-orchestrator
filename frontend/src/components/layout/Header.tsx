          ...
          <div className="flex items-center gap-3">
           ...
           <div className="flex items-center gap-6">
             ...
             <div className="relative group">
               <button className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 transition-colors font-medium text-sm border border-emerald-200">
                 <svg
                   className="w-4 h-4"
                   fill="none"
                   stroke="currentColor"
                ...
                <div className="absolute left-0 mt-0 w-52 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                 <a
                   ...
                   className="block w-full text-left px-4 py-3 hover:bg-emerald-50 text-gray-700 hover:text-emerald-700 border-b border-gray-100 first:rounded-t-lg transition-colors"
                 >
                   <div className="flex items-center gap-2">
                     <svg
                       className="w-4 h-4"
                 ...
                 >
                   <div className="flex items-center gap-2">
                     ...
                     <span className="font-medium">OpenAPI Schema</span>
                   </div>
                   <div className="text-xs text-gray-500 mt-1">OpenAPI 3.1.0 spec</div>
                 </a>
               </div>
             </div>
